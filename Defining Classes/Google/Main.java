...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, Person> peopleData = new HashMap<>(); // Durji imena , klasa Person
        while(!information.equals("End")){
            ...
            String commandType = parameters[1]; // company,pokemon,,parents,children,car;
